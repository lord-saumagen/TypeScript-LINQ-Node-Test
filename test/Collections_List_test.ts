...
var carEnum: TS.Linq.Enumerator<DATA.DATA.Car>;
...
var createCustomerArray: () => Array<DATA.DATA.ICustomer>;
...
suite("TS.Collections.List", () =>
{
  before(function ()
  {
    ...
    carEnum = new TS.Linq.Enumerator<DATA.DATA.Car>(DATA.DATA.CreateCarsArray());
    strEnum = new TS.Linq.Enumerator<string>(DATA.DATA.CreateStringArray());
    lowCharEnum = new TS.Linq.Enumerator<string>(DATA.DATA.lowerCharArray);
  ...
  suite("aggregate", () => 
  {
    ...
    let carList: TS.Collections.List<DATA.DATA.ICar>;
    ...
    {
      carList = new TS.Collections.List<DATA.DATA.ICar>(false, carEnum);
      carNumberResult = carList.aggregate((first: number, second: DATA.DATA.Car) => first + second.horsePower, 0);
    ...
    {
      carStringResult = carList.aggregate((first: string, second: DATA.DATA.Car) => first + second.name, "");
  ...
  suite("defaultIfEmpty", () =>
  {
    ...
    {
      carList = new TS.Collections.List<DATA.DATA.ICar>(false);
  ...
  {
    let numList: TS.Collections.List<number>;
    let resultCarList: TS.Collections.List<DATA.DATA.ICar>;
    let doubleCarList: TS.Collections.List<DATA.DATA.ICar>;

    test("Should return list with the expected elements.", () =>
    {
      doubleCarList = new TS.Collections.List<DATA.DATA.ICar>(false, carEnum).add(...createCarsArray());
  ...
  {
    let numList: TS.Collections.List<number>;
    let cusList: TS.Collections.List<DATA.DATA.ICustomer>;
    ...
    {
      cusList = new TS.Collections.List(false, createCustomerArray());
  ...
  suite("groupBy", () =>
  {
    let cusResultList: TS.Collections.List<TS.Linq.Grouping<string, DATA.DATA.ICustomer>>;
    let resultProdList: TS.Collections.List<TS.Linq.Grouping<string, DATA.DATA.IProduct>>;
    ...
    {
      cusResultList = new TS.Collections.List<DATA.DATA.ICustomer>(false, custEnum).groupBy(_CUST => _CUST.Country).toList();
    ...
    {
      resultProdList = new TS.Collections.List(false, createProductArray()).groupBy(item => TS.Utils.findSingleCurrency(item.Currency).Code).toList();
    ...
    test("Should return 5 elements for the executed expression with elementSelector.", () =>
    {
      ...
      resultProdListStorageRoom = new TS.Collections.List(false, createProductArray()).groupBy(item => TS.Utils.findSingleCurrency(item.Currency).Code, equComp, (item) => item.Storage.Room).toList();
  ...
  suite("groupJoin", () =>
  {
    ...
    {
      cusList = new TS.Collections.List<DATA.DATA.ICustomer>(false, custEnum);
    ...
    {
      cusList = new TS.Collections.List<DATA.DATA.ICustomer>(false, custEnum);
      let result = cusList.groupJoin(ordEnum, (outerItem) => outerItem.CustomerID, (innerItem) => innerItem.CustomerID, (outerItem, group) => ({ CustID: outerItem.CustomerID, CustName: outerItem.ContactName, OrderGroup: group }), (outerKey: string, innerKey: string) => outerKey == innerKey).toList();
      assert.equal(result.count(), 91, "Should return 91 elements for the executed expression.");
    });
  ...
  suite("indexOf", () =>
  {
    let numList: TS.Collections.List<number>;
    let cusList: TS.Collections.List<DATA.DATA.ICustomer>;
    let searchItem: DATA.DATA.ICustomer;
  ...
  suite("intersect", () => 
  {
    let numList: TS.Collections.List<number>;
    let cusList: TS.Collections.List<DATA.DATA.ICustomer>;
    let cusIntersectArray: Array<DATA.DATA.ICustomer>;
    ...
    {
      cusList = new TS.Collections.List(false, custEnum);
      cusIntersectArray = new Array<DATA.DATA.ICustomer>();
  ...
  {
    let numList: TS.Collections.List<number>;
    let ordList: TS.Collections.List<DATA.DATA.IOrders>;
  ...
  suite("orderBy", () => 
  {
    let sortTestList: TS.Collections.List<DATA.DATA.ISortTestItem>;
    let orderCorrect: boolean;
    let lastItem: DATA.DATA.ISortTestItem;
    let cusList: TS.Collections.List<DATA.DATA.ICustomer>;


    test("The result sequence should have the same size as the source sequence.", () =>
    {
      sortTestList = new TS.Collections.List<DATA.DATA.ISortTestItem>(false, createSortTestArray());
    ...
    {
      let numList = new TS.Collections.List(false, createRandomNumberArray(100)).orderBy(item => item).toList();
    ...
    test("Should returns an list of customers sorted by country in ascending order.", () =>
    {
      ...
      let lastCusItem: DATA.DATA.ICustomer = null;
  ...
  suite("orderByDescending", () =>
  {
    ...
    {
      let numList = new TS.Collections.List(false, createRandomNumberArray(100)).orderByDescending(item => item).toList();
  ...
  suite("random", () =>
  {
    ...
    {
      strList = new TS.Collections.List(false, createStringArray()).random().take(50).toList();
  ...
  suite("select", () => 
  {
    ...
    {
      let resultList = new TS.Collections.List(false, createCarsArray()).select(item => ({ buildYear: "'" + item.buildYear + "'", name: "'" + item.name + "'", expensive: ((item.price > 5000) ? "yes" : "no") })).toList();
      expensiveCount = 0;
  ...
  suite("single", () => 
  {
    ...
    test("Should return the expected single result.", () =>
    {
      let result = new TS.Collections.List(false, custEnum).single(CUST => CUST.CustomerID == "OTTIK");
      assert.equal(result.CustomerID, "OTTIK", "Should return the expected single result.");
    });
  ...
  suite("singleOrDefault", () => 
  {
    ...
    test("Should return the expected single result.", () =>
    {
      let result = new TS.Collections.List(false, custEnum).where(CUST => CUST.CustomerID == "OTTIK").singleOrDefault(DATA.DATA.Customer)
      assert.equal(result.CustomerID, "OTTIK", "Should return the expected single result.");
    });

    test("Should return the expected single result.", () =>
    {
      let result = new TS.Collections.List(false, custEnum).singleOrDefault(DATA.DATA.Customer, CUST => CUST.CustomerID == "OTTIK");
      assert.equal(result.CustomerID, "OTTIK", "Should return the expected single result.");
    });

    test("Should return the object created with the default constructor.", () =>
    {
      let result = new TS.Collections.List(false, custEnum).where(CUST => CUST.CustomerID == "NO_CUSTOMER").singleOrDefault(DATA.DATA.Customer);
    ...
    {
      let defaultObj: DATA.DATA.Customer = new DATA.DATA.Customer("Mainstreet 1", "Central City", "2 Bit 2 Fail", "We call you", "", "International", "FOO", "", "555-55-555", "12345", "");
      let result = new TS.Collections.List(false, custEnum).where(CUST => CUST.CustomerID == "NO_CUSTOMER").singleOrDefault(defaultObj);
      assert.deepEqual(result, defaultObj, "Should return the object which was defined as default object.")
    });

    test("Should return the object created with the default constructor.", () =>
    {
      let result = new TS.Collections.List(false, custEnum).singleOrDefault(DATA.DATA.Customer, CUST => CUST.CustomerID == "NO_CUSTOMER");
      assert.deepEqual(result, new DATA.DATA.Customer(), "Should return the object created with the default constructor.")
    });
    ...
    {
      let defaultObj: DATA.DATA.Customer = new DATA.DATA.Customer("Mainstreet 1", "Central City", "2 Bit 2 Fail", "We call you", "", "International", "FOO", "", "555-55-555", "12345", "");
      let result = new TS.Collections.List(false, custEnum).singleOrDefault(defaultObj, CUST => CUST.CustomerID == "NO_CUSTOMER");
      assert.deepEqual(result, defaultObj, "Should return the object which was defined as default object.")
    });
  ...
  suite("union", () => 
  {
    ...
    {
      let resultCarArr1 = new TS.Collections.List<DATA.DATA.ICar>(false, carEnum).union(createCarsUnionTestArray()).toArray();
    ...
    {
      let resultCarArr2 = new TS.Collections.List(false, carEnum).union(createCarsUnionTestArray(), (first, second) => first.name == second.name).toArray();
  ...
  suite("where", () => 
  {
    ...
    test("Should return the expected number of elements for the given query.", () =>
    {
      let result = new TS.Collections.List(false, persEnum).where(pers => pers.FirstName == "Michael");
      assert.equal(result.count(), 5, "Should return the expected number of elements for the given query.");
    });

    test("Should return the expected number of elements for the given query.", () =>
    {
      let result = new TS.Collections.List(false, persEnum).where(pers => pers.FirstName == "Edward");
      assert.equal(result.count(), 3, "Should return the expected number of elements for the given query.");
    });

    test("Should return the expected number of elements for the given query.", () =>
    {
      let result = new TS.Collections.List(false, persEnum).where(pers => pers.FirstName != "");
